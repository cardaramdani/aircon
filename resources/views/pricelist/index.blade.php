            ...
            <div class="page-header mt-5">
                <div class="panel">
                    <div class="row" style="margin-bottom: 1rem;">
                        <div class="col-md-8">
                            <h1 style="font-weight: bold; margin-left: 15px;">Price List</h1>
                        </div>
                        <div class="btn-group col-md-4" role="group" aria-label="Basic example">
                            <button type="button" class="btn-create-data btn btn-secondary " id="tombol-tambah"><i class="fas fa-folder-plus"></i>Add Price</button>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        <div class="card-body">
                        <!-- MULAI TABLE -->
                        <table class="table table-striped table-bordered table-sm" id="table_price_list">
                            <thead>
                                <tr>
                                    <th class="text-left">Tipe AC</th>
                                    <th class="text-left">Kapasitas</th>
                                    <th class="text-left">Deskripsi</th>
                                    <th class="text-left">List Pekerjaan</th>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="" >Select type AC</option>
                                                        <option value="Splite Wall" >Splite Wall</option>
                                                        <option value="Splite duct" >Splite duct</option>
                                                        <option value="Cassette" >Cassette</option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group">
                                                        <select id="kapasitas" name="kapasitas" class="custom-select" >
                                                            <option value="" >Select Kapasitas AC</option>
                                                            <option value="1/2 Pk" >1/2 Pk</option>
                                                            <option value="3/4 Pk" >3/4 Pk</option>
                                                            <option value="1 Pk" >1 Pk</option>
                                                            <option value="1 1/2 Pk" >1 1/2 Pk</option>
                                                            <option value="2 Pk" >2 Pk</option>
                                                            <option value="2 1/2 Pk" >2 1/2 Pk</option>
                                                    ...
                                                    <div class="form-group">
                                                        <input id="deskripsi" type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" placeholder="Deskripsi" value="{{ old('deskripsi') }}" required autocomplete="deskripsi">
                                                    </div>
                                                    <div class="form-group">
                                                        <input id="list_pekerjaan" type="text" class="form-control @error('list_pekerjaan') is-invalid @enderror" name="list_pekerjaan" placeholder="List pekerjaan" required autocomplete="list_pekerjaan">
                                                    </div>

                                                    <div class="form-group">
                                                        <input id="harga" type="text" class="form-control @error('harga') is-invalid @enderror" name="harga" placeholder="Enter Harga" required autocomplete="harga">
                                                    </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_price_list').DataTable().destroy();
                ...
                if (from_date != '' && to_date != '') {
                    $.ajax({
                        ...
                        complete:function(data){
                            location.href="/pricelist/export?"+"from_date="+from_date+"&"+"to_date="+to_date;
                            }
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul-staff').html("Add Price"); //valuenya tambah pegawai baru
        ...
        //                 url: "{{ route('pricelist.store') }}", //url simpan data
        ...
        //                     var oTable = $('#table_price_list').dataTable(); //inialisasi datatable
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "pricelist/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    ...
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_price_list').dataTable();
                        oTable.fnDraw(false); //reset datatable
