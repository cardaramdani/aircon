            ...
            <div class="page-header mt-5">
                <div class="panel">
                    <div class="row" style="margin-bottom: 1rem;">
                        <div class="col-md-8">
                            <h1 style="font-weight: bold; margin-left: 15px;"><span>Permission</span></h1>
                        </div>
                        <div class="btn-group col-md-4" role="group" aria-label="Basic example">
                            <button type="button" class="btn-create-data btn btn-secondary " id="tombol-tambah"><i class="fas fa-folder-plus"></i>Add Permission</button>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        <div class="card-body">
                        <!-- MULAI TABLE -->
                        <table class="table table-striped table-bordered table-sm" id="table_permission">
                            <thead>
                                <tr>
                        ...
                        <div class="modal fade " id="tambah-modal-Permission" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modal-judul" aria-hidden="true">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <input name="permission" id="permission" type="text" class="form-control @error('permission') is-invalid @enderror" role="permission"  placeholder="Enter permission" value="{{ old('permission') }}" required autocomplete="permission" autofocus>
                                                    </div>
...
@section('script')
    ...
    <script>
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul-role').html("Add Permission"); //valuenya tambah pegawai baru
            $('#tambah-modal-Permission').modal('show'); //modal tampil
        });
            ...
            $("#form-tambah").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('permission.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            $('#tambah-modal-Permission').modal('hide'); //modal hide
                            $('#tombol-simpan').html('Simpan'); //tombol simpan
                            var oTable = $('#table_permission').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('permission/edit/' + data_id,
            function (data) {
                console.log(data);
                $('#modal-judul-role').html("Update Permission");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "permission/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    ...
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_permission').dataTable();
                        oTable.fnDraw(false); //reset datatable
